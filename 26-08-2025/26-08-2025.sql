CREATE DATABASE SAI;
USE SAI;
create TABLE Worker (WORKER_ID INT PRIMARY KEY,FIRST_NAME varchar(25) not null,LAST_NAME varchar(25) not null,SALARY INT not null,DEPARTMENT varchar(25) not null);
INSERT INTO Worker 
